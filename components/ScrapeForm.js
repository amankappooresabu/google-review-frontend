...
export default function ScrapeForm() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 flex items-center justify-center p-6 w-full">
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">Reviews Scraper</h1>
          <p className="text-slate-400 text-sm mt-1">Export Google reviews to CSV </p>
        </div>
            ...
            <>
              <div>
                ...
                <input
                  ...
                  className="w-full text-black border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50 placeholder-gray-400"
                />
              </div>
              ...
              <button
                ...
                disabled={!url.trim()}
                className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-gray-200 disabled:text-gray-400 text-white font-semibold py-3 rounded-xl transition-all text-sm shadow-sm"
              >
                Start Scraping
              </button>
